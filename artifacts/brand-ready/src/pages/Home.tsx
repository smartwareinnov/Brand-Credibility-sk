...
import {
  ...
  Users, Rocket, Brain, LineChart, MessageSquare,
...
const faqs = [
  {
    ...
    a: "We scan 8 data sources including your website, social profiles, review platforms, SEO signals, brand mentions, and competitor benchmarks, then weight each dimension to produce a score from 0 to 100. The higher your score, the more likely your ads will convert profitably.",
  },
  {
  ...
  },
  {
    ...
    a: "Most analyses complete in under 3 minutes. Brands with many social channels may take up to 5 minutes.",
  },
  {
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
                Get an AI-powered Ad Readiness Score that scans 8 data sources, benchmarks your competitors, and gives you a step-by-step action plan so you never waste budget on ads again.
              </p>
            ...
            {/* Dashboard hero — built from real UI components matching the provided screenshot */}
            <div className="relative max-w-5xl mx-auto">
              ...
              <div className="relative rounded-2xl border shadow-2xl overflow-hidden bg-[#f0f2f8]">
                ...
                <div className="flex items-center justify-between px-5 py-3 bg-white border-b">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-base tracking-tight">Skorvia</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-full bg-muted flex items-center justify-center">
                      <svg className="w-4 h-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
                    </div>
                    <div className="bg-primary text-white text-xs font-semibold px-3 py-1.5 rounded-lg">+ Analyze</div>
                  </div>
                </div>

                <div className="flex">
                  {/* Sidebar */}
                  <div className="hidden sm:flex w-44 bg-white border-r flex-col py-4 px-3 gap-1 flex-shrink-0">
                    <div className="flex items-center gap-2 px-2 py-2 rounded-lg bg-primary text-white text-xs font-semibold mb-1">
                      <BarChart3 className="h-3.5 w-3.5" /> Overview
                    </div>
                    {["New Analysis", "My Brands"].map(n => (
                      <div key={n} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-muted-foreground text-xs">{n}</div>
                    ))}
                    <p className="px-2 pt-3 pb-1 text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Tracking</p>
                    {["Brand Mentions", "Competitors", "Competitor Analysis", "Competitor Ads Intelligence", "My Analysis", "Daily Tasks"].map(n => (
                      <div key={n} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-muted-foreground text-xs">{n}</div>
                    ))}
                    <p className="px-2 pt-3 pb-1 text-[9px] font-bold text-muted-foreground uppercase tracking-widest">AI Tools</p>
                    {["AI Brand Coach", "Content Generator", "Press Release Builder", "Review Templates", "Industry Benchmarks", "Score Tracker"].map(n => (
                      <div key={n} className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-muted-foreground text-xs">{n}</div>
                    ))}
                  </div>
                  ...
                  <div className="flex-1 p-5 space-y-4 min-w-0">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        <h2 className="text-lg font-bold">Good afternoon, Smartware 👋</h2>
                        <p className="text-xs text-muted-foreground">Here's your brand credibility overview for today.</p>
                      </div>
                      <div className="bg-primary text-white text-xs font-semibold px-3 py-2 rounded-lg flex items-center gap-1.5 flex-shrink-0">
                        + New Analysis
                      </div>
                    </div>

                    {/* Usage bar */}
                    <div className="bg-white rounded-xl border px-4 py-2.5 flex items-center gap-4 text-xs">
                      <div className="flex items-center gap-1.5 font-semibold text-muted-foreground">
                        <TrendingUp className="h-3.5 w-3.5" /> Monthly Usage
                        <span className="bg-muted text-muted-foreground px-1.5 py-0.5 rounded text-[10px] font-medium">Free Plan</span>
                      </div>
                      <div className="flex items-center gap-1.5 flex-1">
                        <span className="text-muted-foreground">Brand Analyses</span>
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-muted-foreground">Ads Intelligence</span>
                        <span className="font-bold">0/1</span>
                      </div>
                      <div className="bg-primary/10 text-primary text-[10px] font-bold px-2 py-1 rounded-lg">Upgrade</div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="bg-white rounded-xl border p-4 flex flex-col items-center justify-center">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wide mb-2">Credibility Score</p>
                        <div className="relative w-20 h-20">
                          <svg width="80" height="80" viewBox="0 0 80 80">
                            <circle cx="40" cy="40" r="30" fill="none" stroke="#e5e7eb" strokeWidth="8" />
                            <circle cx="40" cy="40" r="30" fill="none" stroke="#eab308" strokeWidth="8"
                              strokeLinecap="round"
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-xl font-extrabold text-yellow-500">75</span>
                            <span className="text-[9px] text-muted-foreground font-medium">Almost There</span>
                          </div>
                        </div>
                        <p className="text-[9px] text-muted-foreground mt-2 text-center">Average across all your brand analyses</p>
                      </div>

                      {/* KPI grid */}
                      <div className="col-span-2 grid grid-cols-2 gap-3">
                        {[
                          { label: "CRED SCORE", value: "75/100", sub: "Keep improving", color: "bg-blue-50" },
                          { label: "TASKS DONE", value: "0", sub: "25 pending", color: "bg-green-50" },
                          { label: "BRAND MENTIONS", value: "—", sub: "Set up Google Alerts", color: "bg-purple-50" },
                          { label: "DAYS ON PLAN", value: "1", sub: "Keep the streak!", color: "bg-amber-50" },
                        ].map((k) => (
                          <div key={k.label} className="bg-white rounded-xl border p-3">
                            <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-wide mb-1">{k.label}</p>
                            <p className="text-xl font-extrabold leading-tight">{k.value}</p>
                    ...
                    <div className="bg-white rounded-xl border p-4">
                      <div className="flex items-center justify-between mb-3">
                        <p className="text-sm font-bold">6-Dimension Breakdown</p>
                        <p className="text-[10px] text-muted-foreground">From latest analysis: Smavix Limited</p>
                      </div>
                      <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                        {[
                          { label: "Website Experience", score: 81, color: "bg-green-500" },
                          { label: "Social Media", score: 100, color: "bg-green-500" },
                          { label: "Content Quality", score: 100, color: "bg-green-500" },
                          { label: "Reviews & Trust", score: 25, color: "bg-red-500" },
                          { label: "Competitor Position", score: 80, color: "bg-green-500" },
                          { label: "Messaging Clarity", score: 75, color: "bg-yellow-500" },
                        ].map((d) => (
                          <div key={d.label}>
                ...
                {/* Live pill overlay */}
                <div className="absolute top-14 right-4 bg-white/95 backdrop-blur border rounded-full shadow px-3 py-1.5 flex items-center gap-2 text-xs font-medium">
        ...
        <section className="py-12 border-y bg-muted/20 mt-16">
          <div className="container mx-auto px-4">
            <p className="text-center text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-8">
              We scan data from 8 trusted sources
            </p>
              ...
              {[
                {
                  ...
                  desc: "A single score from 0 to 100 that tells you exactly how ready your brand is to run profitable ads, with a breakdown across 8 dimensions.",
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Social following and engagement gaps",
              ...
              <div className="order-1 md:order-2">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Content, PR, SEO and social guidance",
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { icon: Layers, title: "All-in-One Platform", desc: "Score, coach, competitor intel, and action plan in one dashboard." },
              ].map((item) => (
